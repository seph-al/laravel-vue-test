...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Contacts Index</h2>
        </template>
                                        ...
                                        <tbody class="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                            <tr v-for="contact in contacts" :key="contact.id">
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">{{ contact.organization }}</h2>
                                                    </div>
                                                </td>
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div class="flex items-center gap-4">
                                                        <Link  :href="`/contacts/${contact.id}`" method="delete" as="button" type="button">
                                                        <svg
                                                        ...
                                                        <a x-data="{ tooltip: 'Edite' }" :href="`/contacts/${contact.id}/edit`">
                                                        <svg
                                                            xmlns="http://www.w3.org/2000/svg"
                                                            fill="none"
                                                            viewBox="0 0 24 24"
